  ...
  return (
    ...
    >
      ...
      {options.map((option) => {
        ...
        const accessibleLabel = typeof option.label === "string" ? option.label : String(option.value);
...
function getSegmentButtons(root: HTMLElement) {
  return Array.from(root.querySelectorAll<HTMLButtonElement>("[data-segmented-control-item='true']"));
}
