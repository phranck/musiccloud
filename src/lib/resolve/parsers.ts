import type { AlbumResolveSuccessResponse, ResolveSuccessResponse } from "@/lib/types/api";
import { buildMetaLine, isValidPlatform, PLATFORM_CONFIG, type Platform } from "@/lib/platform/config";
