export type ServiceId = "spotify" | "apple-music" | "youtube" | "soundcloud" | "tidal" | "deezer" | "audius" | "napster";

/** ServiceId plus "cached" for tracks loaded from the database cache */
export type TrackSource = ServiceId | "cached";

const VALID_SERVICE_IDS: readonly ServiceId[] = ["spotify", "apple-music", "youtube", "soundcloud", "tidal", "deezer", "audius", "napster"];
