...
4. For the **dashboard plan only**: look up login credentials from the `reference_local_dashboard_login.md` memory entry. If that memory is missing, abort the dashboard portion and ask the user.
