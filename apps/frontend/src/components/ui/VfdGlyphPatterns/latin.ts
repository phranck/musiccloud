 ...
 * accented variants. Override the diacritic explicitly only when the
 * accent itself should be visible on the matrix.
 */
export const LATIN_GLYPHS: Record<string, readonly string[]> = {
