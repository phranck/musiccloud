 ...
 * feed either view.
 *
 * The covers carry a stable `data-flip-id` (the track key) in both views, so the
 * owning card's {@link import("@/hooks/useTrackViewMorph").useTrackViewMorph}
 * morphs each cover across the switch — the view swap itself stays a plain
 * conditional render.
 *
