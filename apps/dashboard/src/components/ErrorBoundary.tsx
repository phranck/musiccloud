    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
          <div className="text-center max-w-md bg-slate-900 rounded-lg shadow-lg p-8">
            <h1 className="text-2xl font-bold text-white mb-2">{boundaryMessages.title}</h1>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-slate-700 text-white rounded hover:bg-slate-600 transition-colors font-medium text-sm"
              >
