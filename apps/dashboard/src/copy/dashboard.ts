export const dashboardCopy = {
  ...
  developer: {
    ...
    clientsEmptyHint: "Applications appear here with their keys once a developer creates one.",
    ...
    accountDetailDeleteHint:
      "The account and all associated data (projects, applications, API keys) will be permanently deleted.",
    ...
    projectRegistrationsTitle: "Applications",
    projectRegistrationsEmpty: "No applications under this project.",
