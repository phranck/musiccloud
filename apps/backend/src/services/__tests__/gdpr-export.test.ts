 ...
 * a subject's personal data across the developer-account and API-access
 * domains into one versioned JSON structure. Both repositories are stubbed;
 * the assembly logic runs for real.
 */
