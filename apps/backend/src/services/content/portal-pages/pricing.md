musiccloud's API is **free while we build it out**, and it won't stay free forever. Running it has real costs, and paid plans for high-volume and commercial use are planned. Here is what you can count on.
