...
/**
 * Public repository contract for resolver, share-page, crawler, telemetry and
 * website analytics reads/writes.
 *
...
export interface TrackRepository {
  ...
  /**
   * Inserts website analytics batch.
   *
  ...
  /**
   * Gets website analytics overview.
   *
  ...
  /**
   * Gets website analytics drilldown.
   *
   * @param params - The `params` value.
   * @returns The requested repository result.
   */
  ...
  /**
   * Runs website analytics retention.
   *
...
/** Website analytics event type union used by the database repository layer. */
...
/** Website analytics confidence union used by the database repository layer. */
export type WebsiteAnalyticsConfidence = "low" | "medium" | "high";

/** Website analytics session input data shape returned or accepted by the database repository layer. */
...
/** Website analytics event input data shape returned or accepted by the database repository layer. */
...
/** Website analytics batch input data shape returned or accepted by the database repository layer. */
export interface WebsiteAnalyticsBatchInput {
  session: WebsiteAnalyticsSessionInput;
  events: WebsiteAnalyticsEventInput[];
}

/** Website analytics overview data shape returned or accepted by the database repository layer. */
...
/** Website analytics environment summary data shape returned or accepted by the database repository layer. */
export interface WebsiteAnalyticsEnvironmentSummary {
  value: string;
  visitors: number;
}

/** Website analytics bot traffic summary data shape returned or accepted by the database repository layer. */
...
/** Website analytics trend data shape returned or accepted by the database repository layer. */
export interface WebsiteAnalyticsTrend {
  change: number | null;
  status: "changed" | "new" | "none";
}

/** Website analytics event subject data shape returned or accepted by the database repository layer. */
...
/** Website analytics search descriptor data shape returned or accepted by the database repository layer. */
...
/** Website analytics search summary data shape returned or accepted by the database repository layer. */
export interface WebsiteAnalyticsSearchSummary extends WebsiteAnalyticsSearchDescriptor {
  searches: number;
  clusters: number;
}

/** Website analytics interaction summary data shape returned or accepted by the database repository layer. */
...
/** Website analytics path event data shape returned or accepted by the database repository layer. */
...
/** Website analytics Geo activity union used by the database repository layer. */
...
/** Website analytics Geo params data shape returned or accepted by the database repository layer. */
...
/** Website analytics Geo point data shape returned or accepted by the database repository layer. */
...
/** Website analytics Geo location summary data shape returned or accepted by the database repository layer. */
...
/** Website analytics Geo country summary data shape returned or accepted by the database repository layer. */
...
/** Website analytics Geo overview data shape returned or accepted by the database repository layer. */
...
/** Website analytics drilldown params data shape returned or accepted by the database repository layer. */
...
/** Website analytics device summary data shape returned or accepted by the database repository layer. */
...
/** Website analytics session summary data shape returned or accepted by the database repository layer. */
...
/** Website analytics drilldown data shape returned or accepted by the database repository layer. */
...
/** Website analytics export data shape returned or accepted by the database repository layer. */
...
/** Website analytics retention policy data shape returned or accepted by the database repository layer. */
export interface WebsiteAnalyticsRetentionPolicy {
  rawEventsDays: number;
  summariesDays: number;
}

/** Website analytics retention result shape returned or accepted by the database repository layer. */
