...
describe("preview-url", () => {
  it("extracts deezer preview expiry timestamps from signed URLs", () => {
    const url = "https://cdnt-preview.dzcdn.net/api/1/1/d/7/8/0/foo.mp3?hdnea=exp=1772793731~acl=/api/1/1/d/7/8/0/foo.mp3*~data=user_id=0,application_id=42~hmac=abc";
